...
- ARCH-PENDING-001 abierto y no bloqueante para continuar la redacción y revisión de SPEC 001; bloquea únicamente la selección o implementación dependiente de Telefonía IA y WhatsApp.
- ARCH-PENDING-002 abierto y no bloqueante para continuar la redacción y revisión de SPEC 001; bloquea únicamente la aceptación o configuración definitiva de recuperación y continuidad de Production.

## Current Blockers

- ARCH-PENDING-001 activo y PENDING: Proveedor(es) definitivos de Telefonía IA y WhatsApp; no bloquea continuar la redacción y revisión de SPEC 001, pero bloquea únicamente la selección o implementación dependiente. Pueden ser comunes o diferentes; comparar ElevenLabs y al menos una alternativa real para Telefonía IA y analizar capacidades/proveedor de WhatsApp por separado; origen BR-PENDING-001/035 y D014.
- ARCH-PENDING-002 activo y PENDING: no bloquea continuar la redacción y revisión de SPEC 001, pero bloquea únicamente la aceptación o configuración definitiva de recuperación y continuidad de Production; origen ARCH-PENDING-002.
...
La fase Architecture v0.1 está completada y APPROVED por revisión humana de 2026-09-10. Sus 18 ARCH-DEC están aprobadas como decisiones arquitectónicas de esta versión y ARCH-PENDING-001/002 permanecen abiertos y PENDING. Ambos son no bloqueantes para continuar la redacción y revisión de SPEC 001; ARCH-PENDING-001 bloquea únicamente la selección o implementación dependiente de Telefonía IA y WhatsApp, y ARCH-PENDING-002 bloquea únicamente la aceptación o configuración definitiva de recuperación y continuidad de Production. SPEC 001 Core CRM está IN PROGRESS / DRAFT v0.1 tras la redacción autorizada de su borrador; no se ha aprobado. plan.md, tasks.md e implementación continúan no iniciados. ARCH-PENDING-001/002 conservan sus ámbitos de bloqueo y no se han creado SPEC-PENDING nuevos. No se han redactado planes/tareas de implementación ni realizado código, SQL, migraciones, RLS, endpoints definitivos, configuración de proveedores o despliegues. D001–D021 se mantienen sin cambios. SM-PENDING-001/002/003 conservan sus resoluciones históricas y no queda ninguno activo. Business Rules y Domain Model conservan los textos previos de BR-PENDING-027/DM-PENDING-001, BR-PENDING-023/DM-PENDING-003 y BR-PENDING-036/DM-PENDING-004 como antecedentes; se interpretan junto con D018–D020 para sus alcances resueltos.
