...
- D038 APPROVED el 2026-09-26 en `6248820e3253a9d88755ed0a4996fff8f865690e`: F2 define una autoridad humana transaccional separada de F1/D037. Su aprobación documental no inició tareas; una autorización posterior delimitada permitió implementar H0-005 localmente, sin iniciar H0-006.
...
- TSK-H0-006 — Verificación formal F2: FAILED / NOT COMPLETED. [Evidencia adversarial y corrección](../specs/001-core-crm/evidence-TSK-H0-006.md): el ataque histórico permitió a A revocada cambiar generation 1→2 y anular B. H0-006-F01 FIX IMPLEMENTED / PENDING FORMAL REVERIFICATION; el test original ahora pasa, pero la matriz completa sigue incompleta.
...
- Implementación y H0: IN PROGRESS. TSK-H0-001/002/003/004/005/007/008/009/010 COMPLETED en sus alcances históricos; TSK-H0-006 FAILED / NOT COMPLETED y H0-006-F01 pendiente de reverificación formal tras su corrección local; tareas posteriores NOT STARTED. H0 no está completado.
...
- Siguiente acción localizada: nueva verificación normativa H0-006 completa e independiente, con autorización separada; la corrección local focal de H0-006-F01 no basta para cerrarla.
