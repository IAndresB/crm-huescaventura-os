...
- **BR-PACK-003 — Presentación comercial.** En las propuestas comerciales de packs dirigidas al cliente se mostrará, para cada modalidad, únicamente su precio final por persona, su número de participantes y los servicios/elementos que incluye. No se mostrará el desglose económico interno: costes de proveedor, suplidos como desglose comercial interno, comisiones, honorarios Huescaventura, márgenes ni beneficio. El CRM conservará internamente toda la descomposición para cálculo, auditoría y operativa. Una misma propuesta puede incluir varias modalidades, cada una con su propio precio por persona y número de participantes. Los servicios de precio fijo conservan internamente su unidad; presentar un pack por persona no convierte sus componentes en tarifas por persona. Esta regla no altera las obligaciones documentales o fiscales futuras que puedan exigir información distinta fuera de la propuesta comercial.
