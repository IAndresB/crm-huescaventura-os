...
| **Accepted Terms Snapshot — snapshot inmutable** | Contenido exacto y versión efectiva de las condiciones aceptadas, con servicios, precios, pagos, cancelación, condiciones específicas/no reembolsables y mandato cuando correspondan. | Queda fijado por Acceptance junto con la Proposal Version. La referencia a una página o a «términos actuales» no basta para reconstruirlo. Puede referenciar Terms Version conservada sin imponer duplicación física. |
...
|---|---|---|
| Service | Entidad maestra: servicio que puede ofrecerse, de naturaleza propia/interna o externa según el caso verificado. | Catálogo; varias prestaciones Booking Service pueden referenciarlo sin compartir su estado. |
| Service Category | Entidad de configuración: clasificación editable con identidad estable. | Catálogo. Actividad, Alojamiento, Restauración, Ocio nocturno/copas, Transporte, Extra/complemento y Otro son categorías iniciales configurables. Agua/tierra/aire/nieve/indoor son atributos, no categorías rígidas. |
...
| Target Audience Recommendation | Relación configurable Service/Variant ↔ público recomendado, con prioridad Alta/Media/Baja. | Catálogo: despedidas, amigos, empresas, familias, niños, colegios/juveniles y parejas conforme a BR-SVC-005. No acredita elegibilidad. |
...
Fuentes: BR-SVC-001–009, BR-PAX-005/007, BR-SUP-001–004, BR-AVAIL-001–006, BR-ECON-001/006–007, BR-TAR-001.
...
Fuentes: BR-DOC-001–005, BR-TASK-001–007, BR-INC-001–002, BR-COMM-001–006, BR-AI-001–006, BR-AUTO-001–002, BR-HIST-001–005.
...
| Catálogo y reglas maestras | Service y variantes, categorías; Pack, Tariff, Promotion y sus versiones; requisitos aplicables. | Sus referencias históricas permanecen fijadas en propuestas y servicios. La nueva configuración solo gobierna usos posteriores aplicables. |
...
|---|---|---|
| Contact, Organization, Group, roles, Lead, Opportunity | Identidad estable + historial de cambios materiales. | Antes/después, fuente, motivo, actor, fechas; pérdidas y designaciones previas. |
...
| Pack, Tariff, Promotion, reglas/requisitos y términos | Configuración versionada; snapshots de las versiones utilizadas. | Fuente, vigencia aplicable, unidades, condiciones y reglas conocidas, sin inventar valores. |
...
| DM-INV-028 | Cambiar tarifa/pack/promoción/términos actuales no altera historia aceptada; cada importe aplicado debe reconstruirse desde componentes/versiones. | BR-ECON-002–003/006; BR-PROP-006; C P20. |
...
| DM-INV-047 | Todo cambio material conserva quién/cuándo/motivo, antes/después y vínculos; Timeline no sustituye entidades ni amplía permisos. | BR-HIST-001–005; C P06/P07. |
...
| BR-SVC-001–009 | Catálogo/variantes, recomendaciones/restricciones, cantidades/unidades, ubicación y horario propios. | §§4.3, 5.1, 10; DM-INV-013/018–019/025/029. |
...
| C P10/P11; D015 | Actor V1 delimitado, minimización y economía interna reservada en todos los soportes, incluidos vínculos, vistas e IA. |
